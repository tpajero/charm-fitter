...
PARAMETERS = [
    ...
    PlotParameter("r_K3pipi0", title=r"$r_{K\pi\pi^0}$"),
...
RANGES_2D = {
    "LHCb-R1": {
        ("x12", "y12"): (Range((0.0, 8.0), unit="1e-3"), Range((4.0, 9.0), unit="1e-3")),
        ("phiM", "phiG"): (Range((-500.0, 500.0), unit="mrad"), Range((-400.0, 600.0), unit="mrad")),
        ("x", "y"): (Range((-2.0, 8.0), unit="1e-3"), Range((4.0, 9.0), unit="1e-3")),
        ("qop", "phi"): (Range((0.78, 1.18)), Range((-500.0, 400.0), unit="mrad")),
        ("Delta_Kpi", "r_Kpi"): (Range((-0.7, 0.4), unit="rad"), Range((5.8, 6.1), unit="%")),
        ("Acp_KK", "Acp_PP"): (Range((-7.0, 7.0), unit="1e-3"), Range((-7.0, 8.0), unit="1e-3")),
        ("Acp_KK", "phiM"): (Range((-5.0, 5.0), unit="1e-3"), Range((-500.0, 500.0), unit="mrad")),
    },
    "LHCb-R12": {
...
COMBINERS = {
    "LHCb-R1": Combiner(
        300,
        "LHCb Run 1",
        scans_1d=[Scan1D(par, r, parfile="config/start/LHCb-R1.dat") for par, r in RANGES_1D["LHCb-R1"].items()],
        scans_2d=[
            Scan2D(xpar, ypar, xrange, yrange, parfile="config/start/LHCb-R1.dat")
    ...
    "LHCb-R12": Combiner(
        301,
        "LHCb Run 1+2",
        scans_1d=[Scan1D(par, r, parfile="config/start/LHCb-R12.dat") for par, r in RANGES_1D["LHCb-R12"].items()],
        scans_2d=[
            Scan2D(xpar, ypar, xrange, yrange, parfile="config/start/LHCb-R12.dat")
