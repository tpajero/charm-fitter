...
void PDF_yCP_minus_yCP_RS::setObservables(const TString c) {
  ...
  } else if (c.EqualTo("WA-2016")) {
    obsValSource = "https://github.com/tpajero/charm-fitter/blob/main/BLUE/main/ycp-minus-ycp-rs.cpp";
    setObservable("yCP_minus_yCP_RS_obs", 9.15e-3);
  } else if (c.EqualTo("WA-2018")) {
    obsValSource = "https://github.com/tpajero/charm-fitter/blob/main/BLUE/main/ycp-minus-ycp-rs.cpp";
    setObservable("yCP_minus_yCP_RS_obs", 7.42e-3);
  } else if (c.EqualTo("WA-2022")) {
    obsValSource = "https://github.com/tpajero/charm-fitter/blob/main/BLUE/main/ycp-minus-ycp-rs.cpp";
    setObservable("yCP_minus_yCP_RS_obs", 6.99e-3);
  } else {
...
void PDF_yCP_minus_yCP_RS::setUncertainties(const TString c) {
  if (c.EqualTo("LHCb-R1")) {
    ...
    obsErrSource = "https://github.com/tpajero/charm-fitter/blob/main/BLUE/main/ycp-minus-ycp-rs.cpp";
    StatErr = {1.39e-3};
    SystErr = {0.77e-3};
  } else if (c.EqualTo("WA-2018")) {
    obsErrSource = "https://github.com/tpajero/charm-fitter/blob/main/BLUE/main/ycp-minus-ycp-rs.cpp";
