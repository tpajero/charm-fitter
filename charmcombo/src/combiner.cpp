...
void run_combiner(std::string name, theory_config th_cfg, int argc, char* argv[]) {
    ...
    gc.addPdf(1,  new PDF_XY      ("BaBar_Kshh",            th_cfg), "BaBar Kshh");
    gc.addPdf(2,  new PDF_XY      ("BaBar_pipipi0",         th_cfg), "BaBar pipipi0");
    gc.addPdf(3,  new PDF_XY      ("LHCb_KSpipi",           th_cfg), "LHCb KSpipi 2011");
    gc.addPdf(4,  new PDF_Kpipi0  ("BaBar",                 th_cfg), "BaBar Kpipi0");

    gc.addPdf(10, new PDF_RM      ("HFLAV2016",             th_cfg), "R_M HFLAV 2016");
    gc.addPdf(11, new PDF_RM      ("LHCb_K3pi_Run1",        th_cfg), "R_M K3pi LHCb");

    gc.addPdf(20, new PDF_Kshh    ("Belle",                 th_cfg), "Belle Kshh");
    gc.addPdf(21, new PDF_BinFlip ("LHCb_Run1",             th_cfg), "Bin-flip LHCb Run 1");
    gc.addPdf(22, new PDF_BinFlip ("LHCb_Run2_prompt",      th_cfg), "Bin-flip LHCb Run 2 prompt");
    gc.addPdf(23, new PDF_BinFlip ("LHCb_Run2_sl",          th_cfg), "Bin-flip LHCb Run 2 sl");
    ...
    gc.addPdf(33, new PDF_WS      ("LHCb_Prompt_2011_2016", th_cfg), "WS/RS LHCb");
    gc.addPdf(34, new PDF_WS      ("LHCb_DT_Run1",          th_cfg), "WS/RS LHCb DT");

    gc.addPdf(50,  new PDF_Cleo   ("Cleo-c",                th_cfg), "Cleo-c");
    gc.addPdf(51,  new PDF_BES    ("BES",                   th_cfg), "BES");
    ...
    gc.addPdf(70, new PDF_DY      ("WA2020",                th_cfg), "DY (2020 WA)");
    gc.addPdf(71, new PDF_DY      ("WA2021",                th_cfg), "DY (2021 WA)");

    gc.addPdf(80, new PDF_DY_RS   ("LHCb2021",              th_cfg), "DYRS (LHCb 2021)");

    gc.addPdf(100, new PDF_scan_DY_RS(                      th_cfg), "ScanDYRS");

    gc.addPdf(110, new PDF_yCP    ("WA2020_biased",         th_cfg), "y_CP (WA 2020, biased)");
    gc.addPdf(111, new PDF_yCP    ("LHCb2022_biased",       th_cfg), "y_CP - yCP(RS) (LHCb 2022, biased)");
