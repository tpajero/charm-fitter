...
if __name__ == "__main__":
    ...
    parser.add_argument("--lumi-old", type=str, default="LHCb-R2", help="Old luminosity ID")
    ...
    parser.add_argument(
        ...
        type=float,
        default=2.0,
        help="Improvement in yield per luminosity (due eg to removal of L0 trigger between LHCb Run 2 and 3)",
    )
